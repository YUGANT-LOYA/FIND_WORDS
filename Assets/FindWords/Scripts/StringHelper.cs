...
namespace YugantLoyaLibrary.FindWords
{
    public static class StringHelper
    {
        ...
        public static readonly string NEW_QUES_TILE_UNLOCK = "NEW_QUES_TILE_UNLOCK";
        public static readonly string NEW_QUES_TILE_UNLOCK_INDEX = "NEW_QUES_TILE_UNLOCK_INDEX";
